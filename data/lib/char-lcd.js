(function (global, factory) {
  ...
  function CharLCD(obj) {
    ...
    create(_);
    this.set = function (r, c, data) {
      set(_, r, c, data);
    };
    this.char = function (r, c, ch) {
      char(_, r, c, ch);
    };
    this.text = function (r, c, str) {
      text(_, r, c, str);
    };
    this.font = function (n, data) {
      font(_, n, data);
    };
  }
  ...
  function createAt(_) {
    ...
    lcd.style.width = cell * ((1 + CW) * _.arg.cols + 2) + _.arg.brk + "px";
    lcd.style.height = cell * ((1 + HH) * _.arg.rows + 2) + _.arg.brk + "px";
